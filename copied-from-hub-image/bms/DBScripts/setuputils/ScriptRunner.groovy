...
public class ScriptRunner {
  ...
  ScriptRunner() {
    System.out.println("Hello! from ScriptRunner!");
  }
  ...
  public boolean runScript(Reader reader) {
    setAutoCommitInternal();
    boolean success = false;
    try {
      if (sendFullScript) {
        success = executeFullScript(reader);
      } else {
        success = executeLineByLine(reader);
      }
    } finally {
      rollbackConnection();
    }
  ...
  private boolean executeFullScript(Reader reader) {
  ...
  private boolean executeLineByLine(Reader reader) {
  ...
  private static boolean lineIsDelimier(String trimmedLine) {
