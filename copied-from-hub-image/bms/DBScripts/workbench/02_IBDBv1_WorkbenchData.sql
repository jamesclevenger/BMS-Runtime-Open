...
insert into persons (contact, pemail, pextent, pfax, fname, institid, plangu, lname, ioname, pnotes, pphone, poname, ptitle, personid) values ('-', 'admin@leafnode.io', '-', '-', 'Admin', 0, 0, 'Admin', '', '-', '-', '-', '-', 1);

-- The password for admin user is @dm1N
insert into users (uaccess, adate, cdate, instalid, uname, upswd, personid, ustatus, utype, userid)
	values (0, 20141210, 20141210, 0, 'admin', '$2a$10$kx2iupiSGp7Q4A7K8oUx/OZIeS6yEra6KxN0G.9qm2vQloTXzV28K', 1, 0, 0, 1);

insert into users_roles (role, userid) values ('ADMIN', 1);


-- Add Schema Version
INSERT INTO schema_version (version) VALUES ('20150131');
