...
--                                                                                                                                  
-- Host: localhost    Database: chickpea_gms                                                                                        
-- ------------------------------------------------------                                                                           
...
(25,'NAMES','NAME','ADVNM 1','ALTERNATIVE DERIVATIVE NAME 1','-','-',0,0,0,0),
(26,'NAMES','NAME','ADVNM 2','ALTERNATIVE DERIVATIVE NAME 2','-','-',0,0,0,0),
(27,'NAMES','NAME','ADVNM 3','ALTERNATIVE DERIVATIVE NAME 3','-','-',0,0,0,0),
...
(1112,'ATRIBUTS','ATTRIBUTE','BRDR','IRRI BREEDER\'SINITIALS','-','-',12,0,0,0),
...
(1517,'ATRIBUTS','PASSPORT','SOIL_TEX','Soil texture','-','Relative proportions ofsand, silt and clay in a sample',-57,0,20041116,-44),
...
(1529,'ATRIBUTS','PASSPORT','LANG_VAR','Language of variety name','-','Language/dialect ofthe varietal name or vernacular name of wild species',-27,0,20041116,0),
...
(1534,'ATRIBUTS','PASSPORT','ECOZONE','Ecological zone','-','Refers to the edaphic-climatic conditionof the area',-17,0,20041116,-22),
...
(1536,'ATRIBUTS','PASSPORT','DRAINAGE','Drainage','-','Manner in which the waters pass offthe surface of the land',-15,0,20041116,-20),
...
(721,'LISTNMS','LISTTYPE','TOPCROSS','TOPCROSS LIST','-','-',0,0,19960000,0),
...
(2001,'LISTDATAPROPS','LDATA','SSPLOT','Seed source plot','-','Definesa list data property containing the nd_experiment_id for the source plot of advanced seed',0,0,20140616,0),
...
-- Dump completed on 2014-08-15  2:02:00                                                                                            
