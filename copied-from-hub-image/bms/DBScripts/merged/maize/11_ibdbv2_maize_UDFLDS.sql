...
--
-- Host: localhost    Database: ibdbv2_maize_central
-- ------------------------------------------------------
...
INSERT INTO `udflds` (`fldno`, `ftable`, `ftype`, `fcode`, `fname`, `ffmt`, `fdesc`, `lfldno`, `fuid`, `fdate`, `scaleid`) VALUES (415,'LOCATION','LTYPE','FIELD','EXPERIMENTAL FIELD','-','-',0,0,19960000,0),
...
-- Dump completed on 2014-08-11 14:47:04
