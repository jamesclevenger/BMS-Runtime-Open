...
--                                                                                                                                  
-- Host: localhost    Database: lentil_gms                                                                                          
-- ------------------------------------------------------                                                                           
...
(1,'NAMES','NAME','ACCNO','Germplasm bank accession ID','-','ID given to an accession by the genebank holding it. The location of the name and the location of thegermplasm should both be the location of the holding genebank.',1,0,0,0),
...
(6,'NAMES','NAME','CVNAM','Cultivar name','-','The name of a cultivar ofany type ',6,0,0,0),
...
(28,'NAMES','NAME','ALTCRSNM','Alternativecross name','-','-',2,0,0,0),
...
(708,'LISTNMS','LISTTYPE','EXTACQ','EXTERNALSEED ACQUISITION','-','List of incoming seeds acquired from outside IRRI, to be processed through SHU',0,0,0,0),
...
(803,'FACTOR','STUDY','RSTUDY','RalatedStudy','Studyid','The StudyID of the study related to the list',0,117,20060234,0),
...
(1115,'ATRIBUTS','ATTRIBUTE','INGER','INGER IRTP NUMBER, ORIGIN, VARIETY GROUPAND PHOTO','IRTP,5,I,1;ORIG,4,I,1;VARGP,2,I,1;PHOTO,2,I,1','-',15,0,0,0),
(1117,'ATRIBUTS','ATTRIBUTE','COBJ','CROSS OBJECTIVES','-','-',17,0,0,0),
(1118,'ATRIBUTS','ATTRIBUTE','ECO','CIAT ECOSYSTEMS','-','-',18,0,0,0),
(1120,'ATRIBUTS','ATTRIBUTE','COLL','GERMPLASMCOLLECTION ATTRIBUTE','ACCNO,10,A,1;SPECIES,\";\",A,1;MISSCODE,\";\",A,1;COLLECNO,\";\",A,1;DCCODE,\";\",A,1;SOURCE,\";\",A,1;DISO,\";\",A,1;','ACCESSION NO INCLUDING BANK ID; SPECIES NAME; COLLECTING MISSION CODE; COLLECTOR\'S SPECIMEN NO; DONOR\'S CODE; ENVIRONMENT WHERE COLLECTED(1=FARMLAND, 2=THRESHING, 3=FARM STORE, 4=VILLAGE MARKET,5=COMMECIAL MARKET,6=INSTITUTE,7=FIELD BORDER,8=WILD,9=OTHER)',20,0,0,0),
...
(1525,'ATRIBUTS','PASSPORT','REM_GRAI','Grain characteristics','-','Graincharacteristics as observed by the collector\n',-37,0,20041116,0),
(1526,'ATRIBUTS','PASSPORT','MNG_VAR','Meaning of variety name inenglish','-','Translation of the vernacular name into English',-33,0,20041116,-30),
...
(1540,'ATRIBUTS','PASSPORT','STATUS_ACC','Accession status for distribution (i.e. AV or NA)','-','-',0,0,0,-1028),
(1541,'ATRIBUTS','ATTRIBUTE','STRAIN','STRAIN','-','-',0,0,0,0),
(1542,'ATRIBUTS','ATTRIBUTE','GENOTYPE','GENOTYPE','-','-',0,0,0,0),
...
(1603,'GEOREF','LLSOURCE','CFORM','Collecting form','-','Coordinates were on collecting form with no information on the source of data. A scanned copy of thecollecting form should be accessible through the GID and document/image management system',0,298,20090421,0),
...
(1605,'GEOREF','LLSOURCE','CMISS','Collection mission report','-','Coordinates were in a report on acollecting mission, with no information on the source of the data. A scanned copy of the report should be accessible through the GID and document/image management system, with ID in LLRef',0,298,20090421,0),
...
(1609,'GEOREF','LL_FMT','DMS','Degree-Minutes-Seconds','-','Original data provided to the nearest second in theformat D°M\'S\"H',0,298,20090421,0),
...
(1550,'ATRIBUTS','PASSPORT','RMKS','Remarks','-','-',0,0,0,0),
(1543,'ATRIBUTS','PASSPORT','HIST','History ofthe accession','-','-',0,0,0,0),
...
-- Dump completed on 2014-08-14 17:27:27                                                                                            
