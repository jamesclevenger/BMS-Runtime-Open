...
(1,'NAMES','NAME','ACCNO','GERMPLASM BANK ACCESSION NUMBER','-','-',1,0,19960000,0),
...
(10,'NAMES','NAME','FACCN','FOREIGN ACCESSIONNUMBER','-','-',0,0,19960000,0),
...
(105,'ATRIBUTS','ATTRIBUTE','PROGM','INSTITUTEAND BREEDING PROGRAM','-','-',11,0,19960000,0),
...
(210,'ATRIBUTS','METHOD','MT','AGENT OR METHOD OF INDUCEDMUTATION','MTAGNT,,A,1','-',10,0,19960000,0),
(211,'ATRIBUTS','METHOD','MATT','GENERAL METHOD ATTRIBUTE','-','Describe the method oragent employed in a specific instance of a method',0,0,19960000,0),
...
(213,'ATRIBUTS','METHOD','MCOLL','METHODSOF COLLECTION','-','-',0,0,19960000,0),
...
(301,'LOCDES','DESCRIPTOR','ALT','ALTITUDE ABOVE SEA LEVEL','ALT,6,A,1','ALTITUDE IN M ABOVESEA LEVEL RIGHT JUSTIFIED',0,0,19960000,0),
...
(318,'LOCDES','DTYPE','Plot1L','Plot1L','-','Position in m of the start of plot 1 of the block along the lengthof the field',0,0,19960000,0),
(319,'LOCDES','DTYPE','Plot1W','Plot1W','-','Position in m of the start of plot 1 of the block acrossthe width of the field',0,0,19960000,0),
...
(708,'LISTNMS','LISTTYPE','EXTACQ','EXTERNAL SEEDACQUISITION','-','List of incoming seeds acquired from outside IRRI, to be processed through SHU',0,0,19960000,0),
...
(1403,'ATRIBUTS','PASSPORT','REM_OTH','Other observationsof the collector','-','-',-39,0,20041116,541),
...
(1605,'GEOREF','LLSOURCE','CMISS','Collection mission report','-','Coordinates were in a report on a collecting mission, with no information on the source of the data. A scanned copy of the report should be accessible through the GID and document/image managementsystem, with ID in LLRef',0,298,20090421,0),
...
(1610,'GEOREF','LL_FMT','DD','Decimal Degrees','-','Original data provided in decimal degrees in the format D.DDDDD (negativefor S and W)',0,298,20090421,0),
...
(1806,'EVENTMEM','MEMROLE','ADDRESSEE','Addresseeof shipment','-','Person to whom a shipment is addressed',0,298,20090424,0),
...
(304,'LOCDES','DTYPE','LLANTN','LAT-LONGANNOTATION',' ','Annotation of lat-long coordinates including georeferencing',0,298,20090527,0),
...
(414,'LOCATION','LTYPE','COLLMISS','COLLECTING MISSION','-','Region covered by a collecting mission (This location type is necessary so that we can tie the NLocNof names of type COLLNO to their collecting mission)',0,298,20090424,0),
...
(1325,'LOCDES','DTYPE','CNTRY','ISO COUNTRY DESCRIPTORS','CCODE,4,I,1;FAOCODE,4,I,1;ISOCODE,4,I,1;CC2,3,A,1;TELEX,4,I,1;GEOR,3,A,1;ECOR,3,A,1;WHR,3,A,1;MZR,3,A,1;CNAME,,A,1','CCODE: COUNTRY CODE NUMBER, FAOCODE: FAO COUNTRY CODE NUMBER,ISOCODE: ISO COUNTRY CODE NUMBER,CC2: 2 LETTER COUNTRY CODE,TELEX: INT\'L TELEX NUMBER,GEOR: GEOGRAPHIC REGION,ECOR: ECONOMICREGION,WHR WHEAT REGION,MZR: MAIZE REGION,CNAME: LONG COUNTRY NAME',25,0,20000000,0),
(1501,'ATRIBUTS','PASSPORT','SOURCE_I','Sourceof information','-','Refers to the person or publication where the passport information was obtained',-2175,0,20041116,0),
